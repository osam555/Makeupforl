      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="flex gap-2 flex-wrap">
            {(['all', 'pending', 'confirmed', 'completed', 'cancelled'] as const).map((status) => (
              <Button
                ...
                size="sm"
                className={filter === status ? 'bg-[var(--a-f46e65)] hover:bg-[var(--a-e2564c)]' : ''}
              >
        ...
        {loading ? (
          <div className="text-center py-12">
            <div className="inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-[var(--a-f46e65)] border-r-transparent"></div>
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <a href={`tel:${booking.phone}`} className="text-[var(--a-f46e65)] hover:underline">
                            {booking.phone}
                          </a>
                        </div>
                        {booking.email && (
                          <div className="flex items-center gap-2">
                            ...
                            <a href={`mailto:${booking.email}`} className="text-[var(--a-f46e65)] hover:underline">
                              {booking.email}
                            </a>
                          </div>
                        )}
