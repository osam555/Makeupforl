...
export const metadata: Metadata = {
  ...
  description:
    '혼주 올림머리, 정수리 탈모, 퍼스널컬러 한복 색상까지. 20년 1만 명의 노하우로 결혼식 날 가장 잘 어울리는 모습을 미리 찾아드립니다.',
...
const HELPS = [
  ...
  },
  {
    n: 10,
    t: '그 밖의 모든 궁금증',
    d: '20년 동안 1만 명의 메이크업을 하며 터득한 노하우와 혼주를 사랑하는 마음까지, 메이크업포엘의 「혼주 메이크업 연구소」를 통해 칭찬 듬뿍 받는 혼주가 되시도록 돕겠습니다.',
  },
]
