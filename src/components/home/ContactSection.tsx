      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-12">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            메이크업과 에스테틱의 모든 과정은
            <br />
            <span className="text-pink-600">100% 예약제</span>로 진행됩니다
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 max-w-4xl mx-auto">
          ...
          <Card className="p-8 hover:shadow-lg transition-shadow">
            <div className="flex flex-col items-center text-center">
              <div className="inline-flex p-4 rounded-full bg-pink-100 mb-4">
              ...
              <Link href="tel:02-323-3321" className="w-full">
                <Button size="lg" className="w-full bg-pink-600 hover:bg-pink-700 text-lg">
                  02-323-3321
                </Button>
              </Link>
