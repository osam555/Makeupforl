...
export const FREE_QNA_DEFAULT = [
  ...
  'p2-05', // 시연 만족도
  'p3-15', // 눈물이 날 것 같은데 걱정이에요 (화면 P3·14)
  'p4-07', // 둥근 얼굴형에 맞는 혼주 머리는? — '혼주머리'
  'p5-13', // 혼주 한복에 어울리는 귀걸이·목걸이는? (화면 P5·11) — '혼주한복'
  /*
    2026-09-11 에 p2-05·p3-14 를 검색어 문항(p4-02·p4-25)으로 바꿨다가 2026-09-13 원장님
    결정으로 되돌렸다 — 파트 1~5 에 하나씩. 검색어는 허브(/혼주머리 등)가 맡는다.
    2026-09-15 파트 3·5 자리를 p3-14(립스틱)·p5-11(안경테) → p3-15(눈물)·p5-13(귀걸이·목걸이)로
    바꿨다(원장님 결정, 제목으로 확인). 이 다섯이 곧 홈 첫 화면 슬라이드다(page.tsx).
  */
]
